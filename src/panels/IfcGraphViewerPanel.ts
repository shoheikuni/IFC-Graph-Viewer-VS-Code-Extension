...
/**
 * This class manages the state and behavior of IfcGraphViewer webview panels.
 *
 * It contains all the data and methods for:
 *
 * - Creating and rendering IfcGraphViewer webview panels
    ...
    return /*html*/ `
	  ...
	  <style>
	    html, body {
          ...
          <meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src ${webview.cspSource}; script-src 'nonce-${nonce}' 'unsafe-eval'; connect-src ${webview.cspSource};" />
          <link rel="stylesheet" type="text/css" href="${stylesUri}">
          <title>IFC Graph Viewer</title>
        </head>
        <body>
          <div id="app"></div>
